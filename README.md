...
[![Build Status](https://jenkins.indigo-datacloud.eu/buildStatus/icon?job=Pipeline-as-code/DEEP-OC-org/marine-classification/master)](https://jenkins.indigo-datacloud.eu/job/Pipeline-as-code/job/DEEP-OC-org/job/marine-classification/job/master/)
...
You can find more information about it in the [DEEP Marketplace](https://marketplace.deep-hybrid-datacloud.eu/modules/deep-oc-marine-classification.html).
...
git clone https://github.com/deephdc/marine-classification
...
```
and open http://0.0.0.0:5000/ui and look for the methods belonging to the `marineclas` module.

### Docker installation

We have also prepared a ready-to-use [Docker container](https://github.com/deephdc/DEEP-OC-marine-classification) to
run this module. To run it:

```bash
docker search deephdc
docker run -ti -p 5000:5000 -p 6006:6006 -p 8888:8888 deephdc/deep-oc-marine-classification
```

Now open http://0.0.0.0:5000/ui and look for the methods belonging to the `marineclas` module.
...
Finally you can [launch a simple webpage](./marineclas/webpage/README.md) to use the trained classifier to predict images (both local and urls) on your favorite browser.
