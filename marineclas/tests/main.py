...
from marineclas import paths


module_name = 'marineclas'
...
def test_load():
    ...
    import marineclas.api


def test_metadata():
    print('Testing local: metadata ...')
    from marineclas.api import get_metadata
...
def test_predict_url():
    ...
    from marineclas.api import predict_url
...
def test_predict_data():
    ...
    from marineclas.api import predict_data
...
def test_train():
    ...
    from marineclas.api import get_train_args, train
