...
from marineclas import paths, utils, config, test_utils
from marineclas.data_utils import load_class_names, load_class_info, mount_nextcloud
from marineclas.train_runfile import train_fn
...
def get_metadata(distribution_name='marineclas'):
    """
